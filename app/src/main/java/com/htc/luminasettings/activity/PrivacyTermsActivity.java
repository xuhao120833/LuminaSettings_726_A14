...
import com.htc.luminasettings.databinding.ActivityPrivacyTermsBinding;
import com.htc.luminasettings.receiver.UcOffCallBack;
import com.htc.luminasettings.widget.ExportDataDialog;
import com.htc.luminasettings.widget.UcOffDialog;
...
public class PrivacyTermsActivity extends BaseActivity implements UcOffCallBack {
    ...
    public void setVisibility() {
        if (SystemProperties.getInt("persist.sys.implicit_policy", 0) == 1) {
