...
import com.htc.luminasettings.databinding.UcOffBinding;
import com.htc.luminasettings.databinding.UpgradeCheckFailBinding;
...
public class UcOffDialog extends Dialog implements View.OnClickListener {
    ...
    public void onClick(View v) {
        ...
        int id = v.getId();
        if (id == R.id.enter) {
            SystemProperties.set("persist.sys.implicit_policy","0");
